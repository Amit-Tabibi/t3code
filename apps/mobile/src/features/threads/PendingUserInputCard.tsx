          ...
          return (
            <View key={question.id} className="gap-2 pt-1">
              <Text
                ...
                className="font-t3-bold text-xs uppercase tracking-[1px] text-neutral-500"
              >
                {question.header}
              </Text>
              <Text
                style={proseDirectionStyle(question.question)}
                className="font-sans text-base leading-snug text-adaptive-neutral-950-50"
              >
                {question.question}
              </Text>
                      ...
                      <View className="min-w-0 flex-1 gap-0.5">
                        ...
                        {description ? (
                          <Text
                            ...
                            className="font-sans text-sm leading-5 text-adaptive-neutral-500-400"
                          >
                            {description}
                          </Text>
                        ) : null}
